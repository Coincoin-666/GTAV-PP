...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid justify-content-end">
            <form method="POST"><a role="button" name="goto_dash" class="text-secondary fs-5" href="../views/dashboard.php">dashboard<i class="fas fa-tachometer-alt ms-2 me-2"></i></a></form>
        </div>
    </nav>
    </div>
