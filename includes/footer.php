            ...
            <div class="text-center small dedication">
                ...
                <div class="collapse" id="collapse_Wang">
                    <div class="card card-body">
                        <p class="text-start" alt="computer first message with the use of the copyleft hack by Li-Chen Wang in 1976">
                        <div class="container d-flex justify-content-center align-items-center">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    ****************************<br>
                                    <br>
                                    TINY BASIC FOR INTEL 8080<br>
                                    VERSION 2.0<br>
                                    BY LI-CHEN WANG<br>
                                    MODIFIED AND TRANSLATED<br>
                                    TO INTEL MNEMONICS<br>
                                    BY ROGER RAUSKOLB<br>
                                    10 OCTOBER, 1976<br>
                                    @COPYLEFT<br>
                        ...
                        <div class="row mt-3 basic_caption text-muted">
                            <p>Reproduction of the first message refering to the 'copyleft' hack, back in 1976.</p>
                            <a href="https://en.wikipedia.org/wiki/Li-Chen_Wang" target="_blank" rel="noopener noreferrer">
                                <p><span class="more_on">Read more on </span>
                                    <i class="fab fa-wikipedia-w me-1"></i>
                ...
                <div class="collapse" id="collapse_Stallman">
                    <div class="card card-body">
                        <div class="container text-center">
                            <p><a href="https://www.gnu.org/gnu/manifesto.en.html" target="_blank" rel="noopener noreferrer">GNU Manifesto</a><i class="fas fa-external-link-alt ms-1"></i></p>
                            <p><a href="https://en.wikipedia.org/wiki/Richard_Stallman" target="_blank" rel="noopener noreferrer"><i class="fab fa-wikipedia-w me-1"></i>Richard Stallman</a><i class="fas fa-external-link-alt ms-1"></i></p>
                        </div>
                    </div>
                </div>
                <div class="collapse" id="collapse_Barlow">
                    <div class="card card-body">
                        <div class="container text-start small DIC">
                            <div class="row">
                                <div class="col-6 offset-3">
                                    <p><strong>Declaration of the Independence of the Cyberspace</strong></p>
                                    <p><em>by John Perry Barlow</em></p>
                        ...
                        <div class="col-6 offset-3">
                            <p class="text-muted small">trad fr à venir.</p>
                            <p>Read more on <a href="https://www.eff.org/cyberspace-independence" target="_blank" rel="noopener noreferrer">the EFF website</a><br><span class="text-muted fst-italic small">(Electronic Frontier Foundation)</span></p>
                        </div>
                    </div>
                </div>
            </div>
